...
class OrderTrackingViewModel extends MyBaseViewModel {
  ...
  void getPolyline() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      ...
      request: PolylineRequest(origin: PointLatLng(pickupLatLng!.latitude, pickupLatLng!.longitude), destination:       PointLatLng(destinationLatLng!.latitude, destinationLatLng!.longitude),
