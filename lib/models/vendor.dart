...
import 'package:superapp/models/delivery_slot.dart';
import 'package:superapp/models/fee.dart';
import 'package:superapp/models/menu.dart';
import 'package:superapp/models/package_type_pricing.dart';
import 'package:superapp/models/vendor_date.dart';
...
class Vendor {
  ...
  factory Vendor.fromJson(
    ...
    Vendor vendor = Vendor(
      ...
      prepareTimeUnitRaw: json["prepare_time_unit"] != null
      ...
      deliveryTime: json["delivery_time"] != null
          ...
          : "40",
      deliveryTimeUnitRaw: json["delivery_time_unit"] != null
