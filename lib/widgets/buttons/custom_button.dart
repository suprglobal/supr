...
class CustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final languageCode = translator.activeLocale.languageCode;
    return ButtonTheme(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: this.color ?? AppColors.primaryColor,
          disabledBackgroundColor: this.loading ? AppColors.primaryColor : null,
          shape: this.shape ??
              RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(this.shapeRadius ?? 12),
              ),
        ),
