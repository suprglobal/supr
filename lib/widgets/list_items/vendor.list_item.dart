...
import 'package:superapp/widgets/buttons/route.button.dart';
import 'package:superapp/widgets/currency_hstack.dart';
import 'package:superapp/widgets/custom_image.view.dart';
import 'package:superapp/widgets/tags/delivery.tag.dart';
import 'package:superapp/widgets/tags/time.tag.dart';
import 'package:superapp/widgets/tags/pickup.tag.dart';
              ...
              child: Visibility(
                ...
                child: VxBox(
                  child: "Closed".tr().text.lg.white.bold.makeCentered(),
                    ...
                    .color(
                      AppColors.closeColor.withOpacity(0.6),
                    )
                    .make(),
              ),
              bottom: 0,
