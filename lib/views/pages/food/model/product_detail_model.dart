...
class ProductDetailModel {
  final bool? success;
  final  ProductDetailRecord? data;
  ...
  factory ProductDetailModel.fromJson(Map<String, dynamic> json) => ProductDetailModel(
    ...
    data: json["data"] == null ? null :  ProductDetailRecord.fromJson(json["data"]),
...
class  ProductDetailRecord {
  ...
  factory  ProductDetailRecord.fromJson(Map<String, dynamic> json) =>  ProductDetailRecord(
    id: json["id"],
...
class Restaurant {
  ...
  Restaurant copyWith({
    ...
    DateTime? updatedAt,
    String? deletedAt,
    String? logoUrlFormatted,
    String? bannerUrlFormatted,
    String? fullAddress,
    bool? isOpen,
